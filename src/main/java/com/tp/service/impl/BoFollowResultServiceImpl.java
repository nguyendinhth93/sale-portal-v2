...
import com.tp.model.QBoCheckupResult;
...
import com.tp.service.BoFollowResultService;
...
@Service
public class BoFollowResultServiceImpl extends BaseServiceImpl implements BoFollowResultService {
    ...
    public ResponseSearchDTO<BoCheckupResultDTO> load(RequestSearchDTO requestSearchDTO) throws Exception {
        BoFollowResultSearchDTO boCheckupResultInputSearchDTO = (BoFollowResultSearchDTO) requestSearchDTO;
        return repo.searchBoFollowResult(boCheckupResultInputSearchDTO);
    }
