...
@Component
@Scope("view")
public class SaleFunnelCcaController extends BaseController{

    final static Logger logger = LoggerFactory.getLogger(SaleFunnelCcaController.class);

    private static final String TEMPLATE_FILE_NAME          = "SALE_FUNNEL_CCA.xlsx";
    private static final String BASE_FILE_NAME_EXPORT       = "saleFunnelCca";

    @Autowired
    private SaleFunnelCcaService saleFunnelCcaService;
    @Autowired
    ...
    public void init(){
        try {
            ...
            lazyLoadSaleFunnelCca = new SnDataModel<>(saleFunnelCcaService, saleFunnelCCASearchDTO);
            partnerDTOs = partnerService.findAllPartner();
            lstProvinces = areaService.findAllProvince();
            lstBoundCodes = saleFunnelCcaService.findAllBoundCode();
    ...
    public void exportData() {
        try {
            ...
            List<SaleFunnelCcaDTO> lstData = saleFunnelCcaService.load(inputSearchExport).getData();
