...
public class CreditScoringDTO extends BaseDTO implements Serializable {
public static enum COLUMNS {CREATEDBY, CREATEDDATE, CREDITSCORING, ID, ISDN, LATESTDATECALL, LATESTRESPONSECODE, LATESTRESPONSEDES, PROGRAMCODE, RECEIVEDATE, STATUS, STATUSDES, TOTALTIMECALLAPI, TRANSID, UPDATEDBY, UPDATEDDATE, EXCLUSE_ID_LIST};    private String createdBy;
