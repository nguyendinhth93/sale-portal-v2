...
@Entity
@Table(name="credit_scoring")
public class CreditScoring extends BaseModel implements Serializable{
	private static final long serialVersionUID = 5022747088974723782L;
